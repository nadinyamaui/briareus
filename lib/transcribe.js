...
// The API takes ISO 639-1 codes only, and answers 400 to anything else. A
// browser's languages carry a few it knows under another name: Norwegian
// Bokmål and Nynorsk (nb, nn) as no, Filipino (fil) as Tagalog, and the
// retired iw for Hebrew.
...
// half, and guesses the language itself when there is none, or none it takes
// (yue). signal: aborts the call when whoever asked for it has gone.
/**
 * @param {Buffer} audio
