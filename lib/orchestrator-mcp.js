...
const TOOLS = [
  ...
  },
  {
    ...
    description:
      ...
      'should answer), branch, pull request, cost and the first line of its latest reply.',
  ...
  },
  {
    ...
    description:
      'Rule on the review round a worker’s review loop is holding for you: one verdict per finding, by the ' +
