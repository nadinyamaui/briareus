...
const IMPLEMENT_FEEDBACK = [
  ...
  '3. Decide which open findings require a fix by checking the current code, the pull request goal and the evidence in each comment; implement the smallest correct change for each valid, in-scope issue. Change nothing nobody asked for: no drive-by refactors, no formatting sweeps, no dependency bumps.',
